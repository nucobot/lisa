...
GENERATOR_MARKER = ' # Generated by LISA-INSTALL-PY' 

DEPS = ["ros-hydro-ros-control", 
        "ros-hydro-rosserial",
        "ros-hydro-openni-launch",
        "ros-hydro-imu-filter-madgwick"]
...
try:
    LISA_SIMULATION=os.environ["LISA_SIMULATION"]
except:
    LISA_SIMULATION="true"

def print_info():
    print bld(wht("\nDEPLOY SCRIPT FOR LISA PROJECT"))
    print bld(wht("author: Anton Mitrokhin, 2015"))
    ...
    print hdr("LISA_SIMULATION")+wht(": ")+okb(LISA_SIMULATION)
    print wht("")
...
def gen_bash_header(logfile=""):
    ...
    if len(str(LISA_SIMULATION)) != 0:
        format_str +='export LISA_SIMULATION=' + str(LISA_SIMULATION) + '\n'
    return format_str
...
parser = argparse.ArgumentParser(description='Deploy script for Lisa project.')
